...
$query = mysqli_query($koneksi, "SELECT * FROM barang ORDER BY id_jenis");
$output = '<option value="">--Pilih Barang--</option>';
while ($row = mysqli_fetch_array($query)) {
  $output .= '<option value="' . $row["id_jenis"] . '">' . $row["barang"] . '</option>';
}
echo $output;
        ...
        <div class="card-body">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-8">
                <div class="input-group">
                  <select class="custom-select" name="produk" id="jenisProduk">
