...
$baluar = $conn->query("SELECT barang_keluar.id_barang_keluar, barang.nama_barang, barang.stok ,barang_keluar.jumlah_keluar, barang_keluar.tanggal_keluar FROM barang_keluar
...
$html .= '
            <tbody>';
// tampilkan data
while ($data = mysqli_fetch_assoc($baluar)) {
    ...
    $html .= "<tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>" . $data['tanggal_keluar'] . "</td>
                        <td width='210' height='13' align='center' valign='middle'>" . $data['nama_barang'] . "</td>
                        <td width='50' height='13' align='center' valign='middle'>" . $data['jumlah_keluar'] . "</td>
